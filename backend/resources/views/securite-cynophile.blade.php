...
<head>
  <meta charset="utf-8">
  <title>Sécurité Cynophile | 2N MULTI SERVICES</title>
...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <div class="text-black pt-16 pb-10 px-6 text-center">
    <h1 class="text-5xl font-bold uppercase">Sécurité Cynophile</h1>
    <p class="text-xl mt-4">L’alliance entre l’humain et l’instinct canin</p>
  </div>

  <!-- Section principale -->
  <section class="max-w-5xl mx-auto py-12 px-6">
    <h2 class="text-2xl md:text-4xl font-bold text-blue-700 mb-6 text-center tracking-wide">Des équipes cynophiles qualifiées et réactives</h2>
    <p class="text-lg mb-10 leading-relaxed text-justify max-w-4xl mx-auto">
      Le binôme maître-chien constitue une solution redoutablement efficace pour sécuriser les sites sensibles, vastes ou à haut risque.
      Chez <strong>2N MULTI SERVICES</strong>, nous mettons à votre disposition des équipes cynophiles qualifiées, alliant l'expertise humaine à l'instinct canin.
      Nos chiens, soigneusement dressés, sont capables de détecter les intrusions, réagir face au danger et dissuader toute tentative malveillante.
      Ils interviennent aux côtés de maîtres-chiens formés aux meilleures techniques de surveillance et d’intervention.
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          ...
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Surveillance de sites industriels/logistiques</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Sécurisation des environnements vastes ou stratégiques grâce à l’instinct canin.</li>
        </ul>
      </div>
      <!-- Bloc 2 -->
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🌙</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Chantiers isolés ou nocturnes</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Présence dissuasive et intervention rapide dans des zones peu fréquentées ou de nuit.</li>
        </ul>
      </div>
      <!-- Bloc 3 -->
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🎪</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Sécurisation d’événements</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Surveillance active de grands rassemblements ou zones périmétriques étendues.</li>
        </ul>
      </div>
      <!-- Bloc 4 -->
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🚨</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Intervention rapide</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Réaction immédiate en cas d’intrusion ou de comportement suspect détecté.</li>
        </ul>
      </div>
    </div>
    ...
    <div class="mt-16 max-w-5xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full">
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Agents cynophiles formés et expérimentés</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Réactivité et dissuasion maximale</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Adapté aux sites sensibles ou isolés</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Surveillance 24h/24 et 7j/7</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
      </div>
    </div>
    ...
    <div class="flex justify-center mt-16">
      <a href="/contact"
         class="px-8 py-4 rounded-lg text-white text-lg font-semibold bg-blue-700 hover:bg-red-600 transition-colors duration-300 shadow-lg hover:scale-105">
        Contactez-nous
      </a>
    </div>
  </section>
