...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <header class="bg-purple-800 text-white py-10 px-6 text-center shadow-md">
    <h1 class="text-4xl font-bold uppercase">Surveillance Événementielle</h1>
    <p class="text-lg mt-4">Une sécurité discrète pour un événement maîtrisé</p>
  </header>

  <section class="max-w-6xl mx-auto py-12 px-6">
    <div class="grid md:grid-cols-2 gap-10 items-start">
      <div>
        <h2 class="text-2xl font-semibold text-purple-700 mb-4">Un service adapté à vos manifestations</h2>
      ...
      <div class="bg-purple-100 border-l-4 border-purple-500 p-6 rounded-lg shadow-inner">
        <h3 class="text-xl font-bold text-purple-800 mb-4">Exemples d'événements sécurisés :</h3>
        <ul class="list-disc list-inside space-y-1 text-lg text-purple-900">
    ...
    <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600">
        <h4 class="text-xl font-bold mb-3">🚪 Contrôle des accès</h4>
        <p>Filtrage rigoureux à l’entrée pour garantir un environnement sécurisé.</p>
      </div>

      <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600">
        <h4 class="text-xl font-bold mb-3">👥 Gestion des flux</h4>
        <p>Canalisation du public pour prévenir les mouvements de foule.</p>
      </div>

      <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600">
        <h4 class="text-xl font-bold mb-3">🎭 Surveillance des zones sensibles</h4>
        <p>Contrôle des coulisses, loges, scènes, équipements techniques, etc.</p>
      </div>

      <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600">
        <h4 class="text-xl font-bold mb-3">🧑‍🤝‍🧑 Assistance et sécurité</h4>
        <p>Accompagnement des participants et intervenants avec réactivité et courtoisie.</p>
      </div>

      <div class="bg-white p-6 rounded-lg shadow-md border-l-4 border-purple-600 md:col-span-2">
        <h4 class="text-xl font-bold mb-3">⚠️ Intervention en cas d’incident</h4>
        <p>Réponse immédiate et efficace en cas de situation anormale ou dangereuse.</p>
      </div>
    </div>

    <div class="mt-12 bg-purple-100 p-6 rounded-lg border border-purple-300 shadow-inner">
      <h5 class="text-xl font-semibold text-purple-800 mb-4">Un accompagnement sur mesure</h5>
      <p class="text-lg">
        Chaque mission est étudiée avec vous pour élaborer une <strong>stratégie de sécurité personnalisée</strong>,
        <strong>efficace</strong> et <strong>conforme à la réglementation</strong>.
      </p>
    </div>
  </section>
