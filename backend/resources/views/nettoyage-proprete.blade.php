...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <header class="bg-blue-800 text-white py-10 px-6 text-center shadow-md">
    <h1 class="text-4xl font-bold uppercase">Nettoyage & Propreté</h1>
    <p class="text-lg mt-4">Des environnements sains pour des équipes productives</p>
  </header>

  <!-- Section principale -->
  <section class="max-w-5xl mx-auto py-12 px-6">
    <h2 class="text-2xl font-semibold text-blue-700 mb-6">Des solutions de nettoyage sur mesure</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white p-6 shadow-md rounded-lg border-l-4 border-blue-600">
        <h3 class="text-xl font-bold mb-3">🧹 Nettoyage Professionnel & Industriel</h3>
      ...
      <!-- Bloc 2 -->
      <div class="bg-white p-6 shadow-md rounded-lg border-l-4 border-blue-600">
        <h3 class="text-xl font-bold mb-3">🧴 Désinfection & Traitement Anti-Bactérien</h3>
        <ul class="list-disc pl-5 space-y-1 text-gray-700 text-sm">
      ...
      <!-- Bloc 3 -->
      <div class="bg-white p-6 shadow-md rounded-lg border-l-4 border-blue-600">
        <h3 class="text-xl font-bold mb-3">🏗️ Nettoyage de Fin de Chantier</h3>
        <ul class="list-disc pl-5 space-y-1 text-gray-700 text-sm">
    ...
    <div class="mt-12 bg-blue-100 p-6 rounded-lg border border-blue-300 shadow-inner">
      ...
      <ul class="list-disc pl-6 text-gray-700 space-y-2 text-lg">
        ...
        <li>Équipes qualifiées & équipements professionnels</li>
        <li>Solutions sur-mesure et personnalisées</li>
        <li>Respect strict des normes d’hygiène et de sécurité</li>
        <li>Propreté irréprochable pour une meilleure image</li>
      </ul>
    </div>
  </section>
