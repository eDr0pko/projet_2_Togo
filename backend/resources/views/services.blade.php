...
<html lang="fr">
    ...
    <body class="bg-gray-50 text-gray-800">
        ...
        <script>
            ...
            const defaultText = "Forces de sécurité privée";

            // Liste des IDs à surveiller
            const ids = [
            "Sécurité-Électronique-bar",
            "Nettoyage-et-Propreté-bar",
            "Sécurité-Incendie-bar"
            ];
            ...
            for (const id of ids) {
                ...
                // Si le haut de l'élément est entre -100px et 30px du haut de l'écran
                if (rect.top >= -10000 && rect.top <= 30) {
                const label = id.replace("-bar", "").replace(/-/g, " ");
                stickyHeader.textContent = label;
                found = true;
                break;
                }
            }
            ...
            if (!found) {
                stickyHeader.textContent = defaultText;
            }
            }
