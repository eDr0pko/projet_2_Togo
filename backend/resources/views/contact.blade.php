    ...
    <body class="bg-gray-50 text-gray-800">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 p-10 max-w-8xl mx-auto items-center bg-white">
            ...
            <div class="bg-white p-6">
                ...
                <input type="text" placeholder="Votre nom" class="border border-gray-300 p-3 rounded w-full" required />
                <input type="email" placeholder="Votre email" class="border border-gray-300 p-3 rounded w-full" required />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input type="text" placeholder="Sujet du message" class="border border-gray-300 p-3 rounded w-full" required />
                <input type="text" placeholder="Votre télephone" class="border border-gray-300 p-3 rounded w-full" />
                </div>
                <textarea placeholder="Votre message" rows="5" class="border border-gray-300 p-3 rounded w-full" required></textarea>
                <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded hover:bg-red-600 font-semibold">
                ENVOYER
                </button>
                </form>
            </div>
