...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <div class="text-black pt-16 pb-10 px-6 text-center">
    <h1 class="text-5xl font-bold uppercase">Sécurité & Gardiennage</h1>
    <p class="text-xl mt-4">Une présence humaine au cœur de votre tranquillité</p>
  </div>

  <!-- Section principale -->
  <section class="max-w-5xl mx-auto py-12 px-6">
    <h2 class="text-2xl md:text-4xl font-bold text-blue-700 mb-6 text-center tracking-wide">Des solutions sur mesure pour chaque besoin</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          ...
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Sites industriels et commerciaux</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Protection contre les vols, actes de vandalisme et intrusions</li>
          <li>Présence dissuasive et contrôle des accès</li>
        </ul>
      </div>
      ...
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🏗️</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Surveillance de chantiers</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Sécurisation des équipements, matériaux et zones sensibles</li>
          <li>Contrôle des accès et rondes régulières</li>
        </ul>
      </div>
      ...
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🏠</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Gardiennage résidentiel</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Veille permanente sur immeubles, villas, résidences privées</li>
          <li>Gestion des visiteurs et sécurité des accès</li>
        </ul>
      </div>
      ...
      <div class="border-l-8 border-blue-600 bg-white rounded-xl p-8 shadow group hover:border-red-600 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
        <div class="flex items-center mb-4">
          <span class="text-3xl mr-3 group-hover:scale-110 transition-transform">🔁</span>
          <h3 class="text-xl font-bold group-hover:text-red-600 transition-colors">Rondes & inspections</h3>
        </div>
        <ul class="list-disc pl-6 space-y-2 text-gray-700 text-base">
          <li>Contrôle des points sensibles et anticipation d'incidents</li>
          <li>Traçabilité électronique possible</li>
        </ul>
      </div>
    </div>
    ...
    <div class="mt-16 max-w-5xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full">
        ...
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Solutions adaptées à chaque site</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
        <div class="flex items-center justify-between px-2 py-2 transition-transform duration-200 hover:scale-105">
          <span class="text-lg md:text-2xl text-gray-700">Réactivité et proximité</span>
          <span class="text-green-600 text-2xl"><i class="fas fa-check-circle"></i></span>
        </div>
      </div>
    </div>
